...
figure;
plot(1:ec(3)-25,aels(:,1)/ns);
hold on;
plot(1:ec(3)-25,aers(:,1)/ns,'g');
figure
plot(1:ec(3)-25,aels(:,2)/ns);
hold on;
plot(1:ec(3)-25,aers(:,2)/ns,'g');
figure
plot(1:ec(3)-25,aels(:,3)/ns);
hold on;
plot(1:ec(3)-25,aers(:,3)/ns,'g');

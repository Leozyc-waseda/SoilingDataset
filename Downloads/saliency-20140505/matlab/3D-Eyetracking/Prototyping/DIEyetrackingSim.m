function error= DIEyetrackingSim(ec,d,R1,a,b,ex,ey,teta,ns)
%%  DIEyetrackingSim(ec,d,R1,a,b,ex,ey,teta,ns)
...
% R1 location of LED#1 (three dimensional vector please!)
...
% teta angle between LED plate with presentation plate
% number of samples
...
for ss = 1:ns
    [pl,pr] = geoModel(d,ec,R1,teta,a,b,ex,ey);
    [cle,cre]=locateEyes(pl,pr,ec(2),a,b);
for xx=x1:xs:x2
    for yy=y1:ys:y2
        for zz=z1:zs:z2

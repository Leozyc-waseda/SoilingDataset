function [pl,pr] =geoModel(d,ec,R1,teta,a,b,ex,ey)
...
pl = [pl1(1)+ex*rand(1) pl2(1)+ex*rand(1) pl3(1)+ex*rand(1) pl4(1)+ex*rand(1); pl1(2)+ey*rand(1) pl2(2)+ey*rand(1) pl3(2)+ey*rand(1) pl4(2)+ey*rand(1)];
pr = [pr1(1)+ex*rand(1) pr2(1)+ex*rand(1) pr3(1)+ex*rand(1) pr4(1)+ex*rand(1); pr1(2)+ey*rand(1) pr2(2)+ey*rand(1) pr3(2)+ey*rand(1) pr4(2)+ey*rand(1)];
%[pl pr] = adjust(pl,pr);

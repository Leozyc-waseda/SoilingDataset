# This .spec file is modified from opencv-1.0.0-8.fc9.src.rpm
#
# To create your own RPM:
#  - download and install opencv-1.0.0-8.fc9.src.rpm
#  - copy the present file into /usr/src/rpm/SPECS/opencv.spec (as root)
#  - cd /usr/src/rpm/SPECS
#  - rpmbuild -ba opencv.spec
# Your binary rpm is in /usr/src/rpms/RPMS and source RPM in /usr/src/rpm/SRPMS
#
# For use with the iLab Neuromorphic Vision C++ Toolkit, install the
# opencv and opencv-devel RPMs that wre generated.
...
%build
%configure --disable-static --enable-python --enable-apps --without-ffmpeg
make %{?_smp_mflags}
...
%changelog
* Wed Jul 30 2008 Laurent Itti <itti@pollux.usc.edu> - 1.0.0-9
- Prep for Mandriva. We have to disable ffmpeg as it won't compile...

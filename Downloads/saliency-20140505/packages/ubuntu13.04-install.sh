...
# You will set up swap using a swap file instead of a dedicated partition:
...
#
#If using an SSD drive, try the following:
...
deb http://mirrors.usc.edu/pub/linux/distributions/ubuntu/ raring main restricted universe multiverse
deb http://mirrors.usc.edu/pub/linux/distributions/ubuntu/ raring-updates main restricted universe multiverse
deb http://mirrors.usc.edu/pub/linux/distributions/ubuntu/ raring-backports main restricted universe multiverse
deb http://mirrors.usc.edu/pub/linux/distributions/ubuntu/ raring-security main restricted universe multiverse

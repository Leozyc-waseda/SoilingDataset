            ...
            */
            ...
            for( int r = 0 ; (int)r < (int)taskVector->size() ; r++ ){
				...
				if (cl==1){
                            ...
                            switch( task ){
                                case 1 : testString = a_2301.at(ind1);ind1++;break ;
                                case 2 : testString = a_1032.at(ind2);ind2++;break ;
                                case 3 : testString = d_2301.at(ind3);ind3++;break ;
                                case 4 : testString = d_1032.at(ind4);ind4++;break ;
                            }
				cout<<r<<"-"<<task<<endl;
                            d->clearScreen() ;

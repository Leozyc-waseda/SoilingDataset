...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/SeaBee/test-SeaBeeInterface.C $
// $Id: test-SeaBeeInterface.C 14376 2011-01-11 02:44:34Z pez $
//
...
void display(Image<PixRGB<byte> > &img);
...
int main(int argc, const char **argv)
{
  ...
  //TODO: fixme: obsolete with the new BeeSTEM
 // rutz::shared_ptr<BeeSTEM_PID_Listener> lis(new BeeSTEM_PID_Listener(b));

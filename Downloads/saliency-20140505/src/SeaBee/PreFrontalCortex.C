...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/SeaBee/PreFrontalCortex.C $
// $Id: PreFrontalCortex.C 8623 2007-07-25 17:57:51Z rjpeters $

#include "SeaBee/PreFrontalCortex.H"
...
(std::string name,
 rutz::shared_ptr<AgentManagerA> ama) : Agent(name)
{
  itsAgentManager = ama;
}

/*!@file GameBoard/psycho-constellation.C Psychophysics main application for constellation concept learning experiment */
...
//                 }
//
//                 if( line.substr(0,4).compare("color:")==0 ){
...
//                         string::size_type uPos = colorStr.find("_");
//                         string redString = colorStr.substr(0,) ;
...
//
//
//                 d->pushEvent("positiveCases:%s"+stringify(positiveCases)+"  minPositiveCase:"+stringify(minPositiveCase));
//                 d->pushEvent("accuracy:%s"+stringify(accuracy)+"   minAccuracy:"+stringify(minAccuracy)) ;
//                 d->pushEvent("sensitivity:%s"+stringify(sensitivity)+"    minSensitivity"+stringify(minSensitivity));
//
//         }while( sensitivity < minSensitivity || accuracy < minAccuracy || positiveCases < minPositiveCase );
//
//         string reportString("") ;

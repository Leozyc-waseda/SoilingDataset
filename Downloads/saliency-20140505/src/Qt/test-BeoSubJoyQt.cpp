...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Qt/test-BeoSubJoyQt.cpp $
// $Id: test-BeoSubJoyQt.cpp 5957 2005-11-16 18:10:52Z rjpeters $
//
...
{
  //Let's get our model manager built
  ...
  //Beowulf
  nub::soft_ref<Beowulf> beow(new Beowulf(manager, "Beowulf Slave",
                                          "BeowulfSlave", false));
  ...
  w.init(sub, beow, decoder, tracker, tracker2, detector);
  w.show();

...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/CUDA/testcudahmaxflsal.C $
// $Id: testcudahmaxflsal.C 12962 2010-03-06 02:13:53Z irock $
//
...
int main(const int argc, const char **argv)
{
  ...
  //Is this initialisation of the cuda saliency device correct !!!how does the neovision2cuda communicate with this class then ??
  nub::ref<CudaSaliency> smt(new CudaSaliency(*mgr));

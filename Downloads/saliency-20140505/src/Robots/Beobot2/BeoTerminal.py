...
class beoTerminal():
	...
	def __init__(self):
		...
		menu_hosts_jfr = gtk.MenuItem("JFR Hosts")
		menu_hosts_jfr.connect("activate",self.on_host_open_load,jfrlist)
		menu_hosts_jfr2 = gtk.MenuItem("Manual Hosts")
		menu_hosts_jfr2.connect("activate",self.on_host_open_load,jfrlist2)
		...
		menu_hosts.append(gtk.SeparatorMenuItem())
		menu_hosts.append(menu_hosts_jfr)
		menu_hosts.append(gtk.SeparatorMenuItem())
		menu_hosts.append(menu_hosts_jfr2)
		menu_hosts.append(gtk.SeparatorMenuItem())
		...
		self.on_host_open_load2(jfrlist)
	...
	def on_host_open_load2(self,load_list):

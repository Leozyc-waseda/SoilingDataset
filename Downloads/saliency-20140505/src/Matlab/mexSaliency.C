/*!@file Matlab/mexSaliency.C This is the MEX file version of the Saliency program<br>
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Matlab/mexSaliency.C $
// $Id: mexSaliency.C 15468 2013-04-18 02:18:18Z itti $
//

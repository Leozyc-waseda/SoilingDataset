/*!@file ArmControl/SaliencyMT.C A class for quick-and-dirty saliency mapping */
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/ArmControl/SaliencyMT.C $
// $Id: SaliencyMT.C 8267 2007-04-18 18:24:24Z rjpeters $
//

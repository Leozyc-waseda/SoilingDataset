/*!@file AppPsycho/psycho-location-vs-identity-cue.C  stimulus presentation program for parity test mental task*/ 
...
std::string getUsageComment()
{
  ...
  com += "\nlogfile=[logfilename.psy] {default = psycho-lvic.psy}\n" ;
...
extern "C" int main ( const int argc, char** argv )
  {
    ...
    argMap["logfile"]="psycho-lvic.psy" ;
    argMap["subject"]="";
    argMap["memo"]="";

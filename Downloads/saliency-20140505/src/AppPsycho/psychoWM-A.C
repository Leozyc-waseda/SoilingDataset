...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/AppPsycho/psychoWM-A.C $
// $Id: psychoWM-A.C 12962 2010-03-06 02:13:53Z irock $
//
...
extern "C" int main(const int argc, char** argv)
{
        ...
        argMap["experiment"]="sorting_strings_in_working_memory-with-audio-presentation";
        argMap["logfile"]="psycho-wm-a.psy" ;

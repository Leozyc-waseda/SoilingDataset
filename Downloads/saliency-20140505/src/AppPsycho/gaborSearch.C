...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/AppPsycho/gaborSearch.C $
// $Id: gaborSearch.C 11629 2009-08-28 01:20:43Z elno $
//
...
int main(int argc, char** argv)
{
  ...
  Image<PixRGB<byte> > dispImg(1280,720,NO_INIT);
    ...
    for (int i = 1; i <= n_gabors_w; i++)
      {
        ...
        ivector[cnt] = gaborFilterRGB(stddev, f,t,h);

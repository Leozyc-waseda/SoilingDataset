...
extern "C" int main ( const int argc, char** argv )
 ...
 //   eyet->setEventLog(el);
    ...
    for(int i = 0 ; i < numOfBlocks ; i++){
      if(mode == 0){
      performCharcterCueingBlock(d,numOfTrials,numOfCountingItems,1,patchNames[1]);
       performCharcterCueingBlock(d,numOfTrials,numOfCountingItems,2,patchNames[2]);
        performCharcterCueingBlock(d,numOfTrials,numOfCountingItems,3,patchNames[3]);

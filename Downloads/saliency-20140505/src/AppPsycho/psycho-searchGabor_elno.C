...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/AppPsycho/psycho-searchGabor_elno.C $
// $Id: psycho-searchGabor_elno.C 12962 2010-03-06 02:13:53Z irock $
//
...
vlist.push_back(std::string(tokens[4]));

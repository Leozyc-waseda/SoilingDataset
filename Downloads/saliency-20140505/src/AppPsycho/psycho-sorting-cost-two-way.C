/*!@file AppPsycho/psycho-sorting-cost-two-way.C Psychophysics test to measure the influence of eyemovement on memory task performance */
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/AppPsycho/psycho-sorting-cost-two-way.C $
// $Id: psycho-sorting-cost-two-way.C 12962 2010-03-06 02:13:53Z irock $
//
        ...
        //let's see in what mode the user like to run the program
            ...
            for( int r = 0 ; (int)r < (int)taskVector->size() ; r++ ){
                           ...
                           if(cue_wait_frames != 0) d->waitFrames(cue_wait_frames) ;
                            ...
                            string imst ;
                            if(task!=0){
                                imst= "===== Showing image: def_"+stringify(task)+"_"+stringify(r)+"_"+testString+".png =====";

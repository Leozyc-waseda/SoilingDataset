/*!@file AppPsycho/psycho-vmc-partitytest.C  stimulus presentation program for parity test mental task*/ 
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Psycho/psycho-vmc-paritytest.C$
...
std::string getUsageComment()
{
  ...
  com += "\nlogfile=[logfilename.psy] {default = psycho-vmc-pt.psy}\n" ;
...
extern "C" int main ( const int argc, char** argv )
  {
	...
	int caught = 0 ;
	int falseAlarm=0;
	evaluateThePerformanceOnParityTestTask(mode, toneSequence , responseSequence , missed , caught , falseAlarm);

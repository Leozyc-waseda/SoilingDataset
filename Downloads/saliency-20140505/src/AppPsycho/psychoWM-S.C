...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/AppPsycho/psychoWM-S.C $
// $Id: psychoWM-S.C 12962 2010-03-06 02:13:53Z irock $
//
...
extern "C" int main(const int argc, char** argv)
{
        ...
        argMap["experiment"]="sorting_strings_in_working_memory-with-moving-stimulus";
        argMap["logfile"]="psycho-wm-s.psy" ;

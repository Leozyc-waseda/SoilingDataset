/*!@file AppPsycho/psycho-vmc-r.C  stimulus presentation program which presents items of visual working memory randomly on the screen*/ 
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Psycho/psycho-vmc-r.C$

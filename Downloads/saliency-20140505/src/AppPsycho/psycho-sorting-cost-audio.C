/*!@file AppPsycho/psycho-sorting-cost.C Psychophysics test to measure the influence of eyemovement on memory task performance */
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/AppPsycho/psycho-sorting-cost-audio.C $
// $Id: psycho-sorting-cost-audio.C 12962 2010-03-06 02:13:53Z irock $
//
...
extern "C" int main(const int argc, char** argv)
{
  ...
  // let's display an ISCAN calibration grid:
        ...
        //let's see in what mode the user like to run the program
            ...
            vector<string> _34012 = getAll_34012();
            vector<string> _21043 = getAll_21043();
            vector<string> _41230 = getAll_41230();
            vector<string> _03214 = getAll_03214();
            scramble(_34012);
            scramble(_21043);
            scramble(_41230);
            scramble(_03214);
            ...
            for( int r = 0 ; (int)r < (int)taskVector->size() ; r++ ){
                            ...
                            d->showCursor(false) ;
                            string testString ;
                            testString = getARandomString(stringSize, argMap["alphabet"]);
                            switch( task ){
                                case 1 : testString = _34012.at(ind1);ind1++;break ;
                                case 2 : testString = _21043.at(ind2);ind2++;break ;
                                case 3 : testString = _41230.at(ind3);ind3++;break ;
                                case 4 : testString = _03214.at(ind4);ind4++;break ;

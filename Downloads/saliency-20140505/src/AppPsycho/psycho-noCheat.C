...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/AppPsycho/psycho-noCheat.C $
// $Id: psycho-noCheat.C 8426 2007-05-24 06:57:57Z itti $
//
...
extern "C" int main(const int argc, char** argv)
{
  ...
  std::string line; int correct = 0, accuracy = 100, total = 0;

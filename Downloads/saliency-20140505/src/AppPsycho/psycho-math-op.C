...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/AppPsycho/psycho-math-op.C $
...
ModelManager manager("Psycho-Math-Op");
...
extern "C" int main(const int argc, char** argv)
{
        ...
        argMap["experiment"]="math-operation-with-played-numbers";
        argMap["logfile"]="psycho-math-op.psy" ;
        argMap["num-of-digits"]="3" ;
        argMap["test-rounds"]="10";
        argMap["subject"]="" ;
        argMap["memo"]="" ;
        argMap["alphabet"]="0123456789";
        argMap["recall-prb"]="0.4" ;
  ...
  // let's display an ISCAN calibration grid:
        ...
        //let's see in what mode the user like to run the program
            ...
            float memPrb = atof(argMap["recall-prb"].c_str()) ;
            ...
            while( cr <numOfTests ){
                ...
                while( Mix_PlayingMusic() == 1 ){}
                    ...
                    if(mP > memPrb){
                            ...
                            std::string imst = "===== Showing image: def"+ stringify(cr)+ ".png =====";
                            d->pushEvent(imst);
                            eyet->track(true);
                            ...
                            string  answer = getDigitSequenceFromSubject(argMap["alphabet"] , numOfDigits);

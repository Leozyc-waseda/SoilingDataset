...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/AppPsycho/psychoWMS-A.C $
// $Id: psychoWMS-A.C 12962 2010-03-06 02:13:53Z irock $
//
...
ModelManager manager("Psycho-WMS");
...
extern "C" int main(const int argc, char** argv)
{
        ...
        argMap["logfile"]="psycho-wms-a.psy" ;

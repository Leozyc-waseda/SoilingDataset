/*!@file AppPsycho/psycho-moving-recall.C  stimulus presentation program for testing of memory recall with moving objects*/ 
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Psycho/psycho-moving-recall.C$
...
std::string getUsageComment()
{
  ...
  com += "\nlogfile=[logfilename.psy] {default = psycho-mv-recall.psy}\n" ;
...
extern "C" int main ( const int argc, char** argv )
  {
	...
	d->clearScreen();
	displayATrainOfMovingCharacters( d ,sequence , isi_frames , clip_size ,  speed  ,  orientation ,  direction);
	d->clearScreen();
	d->displayFixationBlink(-1,-1,5,1);

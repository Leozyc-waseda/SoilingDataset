/*!@file Beobot/test-followColor.C Test color segment following - slave */
// //////////////////////////////////////////////////////////////////// //
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Beobot/test-followColor.C $
// $Id: test-followColor.C 6988 2006-08-11 17:15:38Z rjpeters $
//
...
int main(const int argc, const char **argv)
{
  ...
  while( goforever )
  {
    if( beo->receive( rnode, rmsg, rframe, raction, 10 ) ) // wait up to 10ms
    {
      double speedVal = rmsg.getElementDouble();
      double steerVal = rmsg.getElementDouble();
      LINFO( "Received speed=%f steer=%f", speedVal, steerVal );
      b->setServo(bbc.speedServoNum, (float)speedVal);
      b->setServo(bbc.steerServoNum, (float)steerVal);
    }
  }
}

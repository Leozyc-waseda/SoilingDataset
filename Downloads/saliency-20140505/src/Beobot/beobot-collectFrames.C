/*!@file Beobot/beobot-collectFrames.C
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Beobot/beobot-collectFrames.C $
// $Id: beobot-collectFrames.C 7353 2006-10-30 15:27:31Z rjpeters $
//
...
int main(const int argc, const char* argv[])
{
  ...
  ModelManager manager("Beobot: collect frames");
...
//   const float val = rmsg.getElementFloat();
//   LINFO("rec %f", val);

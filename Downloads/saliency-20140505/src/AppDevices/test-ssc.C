/*!@file AppDevices/test-ssc.C Test SSC serial servo controller */
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/AppDevices/test-ssc.C $
// $Id: test-ssc.C 7912 2007-02-14 21:12:44Z rjpeters $
//

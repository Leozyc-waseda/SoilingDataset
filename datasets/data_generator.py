...
_MYDATA_INFORMATION = DatasetDescriptor(
	splits_to_sizes={
	'train':136, #number of samples in images/training
	'val': 11, #number of samples in images/validation
	},
	num_classes=6,
	ignore_label=255,
	)

_SOILING_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
...
_DATASETS_INFORMATION = {
    ...
    'soiling_dataset': _SOILING_INFORMATION
}
